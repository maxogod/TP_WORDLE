...
def crear_lista_info_jugadores(lista_jugadores):
    '''
    Crea una lista de diccionarios con la información de todos los jugadores. Cada diccionario posee el nombre, puntos y posicion del jugador correspondiente. Retorna la lista.
    '''
    lista_info_jugadores = []
    for cantidad in range(len(lista_jugadores)):
        lista_info_jugadores.append({"nombre": lista_jugadores[cantidad], "puntos": 0, "posicion": cantidad + 1})
...
def cambiar_posicion_jugadores(lista_info_jugadores):
    ...
    for jugador in lista_info_jugadores:
        ...
        posiciones_sin_jugador.remove(jugador['posicion']) if (jugador['posicion'] in posiciones_disponibles) else None
...
def dividir_turnos_jugadores(lista_jugadores, cantidad_turnos):
    '''
    Recibe la lista de diccionarios de jugadores y la cantidad de turnos. Ordena los jugadores por la posición y crea una lista con los nombres de cada jugador.
    Retorna una lista con el nombre del jugador correspondiente al indice de la lista. Turno 1 le toca al jugador de la posicion1 de la lista.
    '''
...
def rejugabilidad():
    ...
    lista_info_jugadores = crear_lista_info_jugadores(jugadores) #lista de diccionarios. Cada diccionario es un jugador y tiene el nombre, los puntos y la posicion.
